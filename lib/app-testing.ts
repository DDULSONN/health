...
export const APP_TEST_PLAY_STORE_URL = "https://play.google.com/store/apps/details?id=com.gymtools.somefit";
...
export function canDownloadAppTest(status: AppTestStatus) {
  return status === "invited" || status === "testing" || status === "completed";
}
