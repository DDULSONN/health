-- 1:1 matching Plus: 30-day user entitlement with idempotent grants.
...
begin
  ...
  -- Preserve a recent refresh made before this event table was introduced.
  if v_used_count = 0
  ...
  if v_used_count >= p_limit then
    return query select
      ...
      0,
      null::timestamptz,
      v_oldest_refresh + interval '24 hours';
    return;
  end if;
