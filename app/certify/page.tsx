    ...
    return (
      <main className="max-w-md mx-auto px-4 py-8">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-4 mt-4 space-y-2">
          <p className="text-sm font-semibold text-neutral-900">영상 이메일 제출 템플릿</p>
          <p className="text-xs text-neutral-600">제목: {mailTitle}</p>
          <p className="text-xs text-neutral-600 whitespace-pre-line">본문: {mailBody}</p>
        </div>
