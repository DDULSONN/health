...
function getPrimaryAction(productType?: string | null) {
  ...
  if (productType === "one_on_one_contact_exchange" || productType === "one_on_one_priority_24h" || productType === "one_on_one_plus_7d" || productType === "one_on_one_plus_30d" || productType === "dating_all_pass_30d") {
    ...
    <main className="mx-auto max-w-2xl px-4 py-8">
      <section className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link
            href={productType === "one_on_one_contact_exchange" || productType === "one_on_one_priority_24h" || productType === "one_on_one_plus_7d" || productType === "one_on_one_plus_30d" || productType === "dating_all_pass_30d" ? "/dating/1on1" : "/mypage"}
          ...
          >
            {productType === "one_on_one_contact_exchange" || productType === "one_on_one_priority_24h" || productType === "one_on_one_plus_7d" || productType === "one_on_one_plus_30d" || productType === "dating_all_pass_30d" ? "1:1 소개팅 보기" : "마이페이지"}
          </Link>
        </div>
      </section>
    </main>
