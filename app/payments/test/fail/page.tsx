...
function TestPaymentFailContent() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-8">
      <section className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-bold text-neutral-900">테스트 결제 실패</h1>
    ...
    <Suspense
      fallback={
        <main className="mx-auto max-w-2xl px-4 py-8">
          <section className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm">
            <h1 className="text-2xl font-bold text-neutral-900">테스트 결제 실패</h1>
            <p className="mt-4 text-sm text-neutral-500">결제 실패 정보를 불러오는 중...</p>
          </section>
        </main>
      }
    >
      <TestPaymentFailContent />
    </Suspense>
  );
}
