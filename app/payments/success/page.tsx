...
function formatProductType(productType?: string, orderName?: string | null) {
  ...
  if (productType === "one_on_one_plus_7d") return "1:1 매칭 플러스 7일";
  if (productType === "one_on_one_plus_30d") return "1:1 매칭 플러스 30일";
  if (productType === "swipe_premium_30d") return "빠른매칭 플러스";
  if (productType === "dating_all_pass_30d") return "매칭 올패스 30일";
...
function getPrimaryAction(productType?: string, orderName?: string | null, province?: string | null) {
  ...
  if (productType === "one_on_one_plus_7d") return { href: "/mypage?section=matching", label: "1:1 매칭으로 돌아가기" };
  ...
  if (productType === "dating_all_pass_30d") return { href: "/community/dating/cards", label: "매칭 시작하기" };
                    ...
                    : result.productType === "paid_card"
                      ...
                      : result.productType === "one_on_one_contact_exchange"
                        ...
                        : result.productType === "one_on_one_plus_7d"
                          ? "1:1 매칭 플러스 7일 적용 완료"
                        : result.productType === "one_on_one_plus_30d"
                          ? "1:1 매칭 플러스 30일 적용 완료"
                        : result.productType === "swipe_premium_30d"
                          ? "빠른매칭 플러스 적용 완료"
                        : result.productType === "dating_all_pass_30d"
                          ? "1:1·빠른매칭 플러스 적용 완료"
