...
export async function GET() {
  ...
  try {
    ...
    const [
      ...
      publicOpenCards,
      pendingOpenCards,
      pendingOpenCardsMale,
      pendingOpenCardsFemale,
      ...
      fetchExactCountSafe(admin.from("dating_cards").select("id", { count: "exact", head: true }).eq("status", "pending").eq("sex", "male")),
      fetchExactCountSafe(admin.from("dating_cards").select("id", { count: "exact", head: true }).eq("status", "pending").eq("sex", "female")),
