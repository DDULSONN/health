...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${baseUrl}/health-fortune`, lastModified: new Date(), changeFrequency: "daily", priority: 0.8 },
    ...
    { url: `${baseUrl}/dating`, lastModified: new Date(), changeFrequency: "daily", priority: 0.9 },
